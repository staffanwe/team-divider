        ...
        <Box className={classes.body}>
          <Box className={classes.choices}>
            <Box onClick={() => history.push('/5man')} className={classes.choice}>
              <Sword height={matches ? 200 : 300} width={matches ? 130 : 200} />
              <Box className={classes.choiceText}>5 MAN</Box>
            </Box>
            <Box onClick={() => history.push('/5v5')} className={classes.choice}>
              <Swords height={matches ? 200 : 300} width={matches ? 200 : 300} />
              <Box className={classes.choiceText}>5 VS 5</Box>
            </Box>
            <Box onClick={() => history.push('/players')} className={classes.choice}>
              <Helmet height={matches ? 200 : 300} width={matches ? 130 : 200} />
